                    ...
                    <div className="w-4/5 md:w-md p-8 space-y-3 rounded-xl bg-slate-100 text-gray-800">
                        ...
                        <form noValidate="" action="" className="space-y-6">
                            <div className="space-y-1 text-sm">
                                ...
                                <input type="text" name="name" placeholder="your name" className="w-full px-4 py-3 rounded-full border-gray-300 bg-white text-gray-800 focus:border-rose-600 outline-primary" />
                            </div>
                            <div className="space-y-1 text-sm">
