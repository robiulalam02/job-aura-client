            ...
            <div className="flex flex-col-reverse md:flex-row justify-between">
                <div className='flex justify-center items-center w-full md:w-6/12'>
                    <div className="w-4/5 md:w-md p-8 space-y-3 rounded-xl bg-slate-100 text-gray-800">
                        <h1 className="text-2xl font-bold">Hi, <br /> <span className='text-primary'>Welcome Back</span>
                        </h1>
                        <form noValidate="" action="" className="space-y-6">
                            <div className="space-y-1 text-sm">
                                <label htmlFor="username" className="block text-gray-600">Email</label>
                                <input type="text" name="username" id="username" placeholder="your email" className="w-full px-4 py-3 rounded-full border-gray-300 bg-white text-gray-800 focus:border-rose-600 outline-primary" />
                            </div>
                            <div>
                            ...
                            <button type='submit' className="block w-full p-3 text-center rounded-full text-gray-50 bg-primary">Sign in</button>
                        </form>
