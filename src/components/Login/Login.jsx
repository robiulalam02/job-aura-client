                    ...
                    <div className="w-4/5 md:w-md p-8 space-y-3 rounded-xl bg-slate-100 text-gray-800">
                        ...
                        <form onSubmit={handleSignIn} className="space-y-6">
                            <div className="space-y-1 text-sm">
                                ...
                                <input type="email" name="email" placeholder="your email" className="w-full px-4 py-3 rounded-full border-gray-300 bg-white text-gray-800 focus:border-rose-600 outline-primary" />
                            </div>
                            <div>
